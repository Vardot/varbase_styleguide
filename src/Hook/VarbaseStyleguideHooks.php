...
namespace Drupal\varbase_styleguide\Hook;
...
/**
 * Hook implementations for the Varbase Styleguide module.
 */
class VarbaseStyleguideHooks {

  use StringTranslationTrait;

  /**
   * Constructs a VarbaseStyleguideHooks object.
   *
   ...
   */
  #[Hook('styleguide_alter')]
  public function styleguideAlter(&$items): void {

    // Change the styleguide-preview.jpg with flag-earth.jpg .
    $image_data = file_get_contents($this->extensionPathResolver->getPath('module', 'varbase_styleguide') . '/images/flag-earth.jpg');
    $file = $this->fileRepository->writeData($image_data, 'public://flag-earth.jpg', FileExists::Replace);
    ...
    $items['varbase_bootstrap_atoms'] = [
      'group' => 'Varbase',
      'title' => $this->t('Bootstrap elements'),
      'content' => [
        '#type' => 'inline_template',
        '#template' => '{{ bootstrap_elements|raw }}',
        '#context' => [
          'bootstrap_elements' => '
      <!-- Navbar
      ================================================== -->
          ...
          <div class="col-lg-4 offset-lg-1">
            <form class="bs-component">
              ...
              <div class="form-group has-success">
                ...
                <div class="valid-feedback">Success! You have done it.</div>
              </div>

              <div class="form-group has-danger">
                <label class="form-control-label" for="inputInvalid">Invalid input</label>
                <input type="text" value="wrong value" class="form-control is-invalid" id="inputInvalid">
                <div class="invalid-feedback">Sorry, that username is taken. Try another?</div>
              </div>
            ...
            <div class="bs-component">
              ...
              <div id="myTabContent" class="tab-content">
                <div class="tab-pane fade show active" id="home">
                  <p>Raw denim you probably haven it heard of them jean shorts Austin. Nesciunt tofu stumptown aliqua, retro synth master cleanse. Mustache cliche tempor, williamsburg carles vegan helvetica. Reprehenderit butcher retro keffiyeh dreamcatcher synth. Cosby sweater eu banh mi, qui irure terry richardson ex squid. Aliquip placeat salvia cillum iphone. Seitan aliquip quis cardigan american apparel, butcher voluptate nisi qui.</p>
                </div>
                <div class="tab-pane fade" id="profile">
                  <p>Food truck fixie locavore, accusamus mcsweeney marfa nulla single-origin coffee squid. Exercitation +1 labore velit, blog sartorial PBR leggings next level wes anderson artisan four loko farm-to-table craft beer twee. Qui photo booth letterpress, commodo enim craft beer mlkshk aliquip jean shorts ullamco ad vinyl cillum PBR. Homo nostrud organic, assumenda labore aesthetic magna delectus mollit.</p>
                </div>
          ...
          <div class="col-lg-12">
            ...
            <div class="bs-component">
              <div class="alert alert-dismissible alert-warning">
                ...
                <p class="mb-0">Best check yo self, you are not looking too good. Nulla vitae elit libero, a pharetra augue. Praesent commodo cursus magna, <a href="#" class="alert-link">vel scelerisque nisl consectetur et</a>.</p>
              </div>
            <br /></div>
          </div>
        </div>
          ...
          <div class="col-lg-4">
            <div class="bs-component">
              <div class="alert alert-dismissible alert-info">
                <button type="button" class="close" data-dismiss="alert">×</button>
                <strong>Heads up!</strong> This <a href="#" class="alert-link">alert needs your attention</a>, but it is not super important.
              </div>
            <br /></div>
          </div>
        </div>
  ...
  <div class="bs-callout bs-callout-info"><strong>Callout Info</strong>: Pellentesque pellentesque tempor tellus eget fermentum. usce lacllentesque eget tempor tellus ellentesque pelleinia tempor malesuada. Pellentesque pellentesque eget tempor tellus ellentesque pellentesque eget tempor tellus.</div>',
    ...
    foreach ($content_types as $content_type) {
      ...
      if (is_array($entity_ids) && count($entity_ids) > 0) {
        ...
        $entity_ids_values = array_values($entity_ids);
        $nid = $entity_ids_values[0];
        ...
        if (isset($node) && is_array($view_modes) && count($view_modes)) {
          foreach ($view_modes as $view_mode => $view_mode_object) {
            ...
            if ($view_mode != 'default' && $view_mode != 'full') {
              ...
              $node_output_with_the_view_mode = $this->renderer->render($node_build);
              ...
              if (preg_match('/xsmall$/', $view_mode)) {
                $node_html = $this->col('col-sm-2', $node_output_with_the_view_mode);
                $final_view_mode_output .= $this->fillRow(6, $node_html);
              }
              // If view mode end with small.
              // print it 4 times.
              elseif (preg_match('/small$/', $view_mode) &&
                       !preg_match('/xsmall$/', $view_mode)) {
                $node_html = $this->col('col-sm-3', $node_output_with_the_view_mode);
                $final_view_mode_output .= $this->fillRow(4, $node_html);
              }
              // If view mode end with medium.
              // print it 3 times.
              elseif (preg_match('/medium$/', $view_mode)) {
                $node_html = $this->col('col-sm-4', $node_output_with_the_view_mode);
                $final_view_mode_output .= $this->fillRow(3, $node_html);
              }
              // If view mode end with large.
              // print it 2 times.
              elseif (preg_match('/large/', $view_mode) &&
                       !preg_match('/xlarge$/', $view_mode)) {
                $node_html = $this->col('col-sm-6', $node_output_with_the_view_mode);
                $final_view_mode_output .= $this->fillRow(2, $node_html);
              }
              else {
                $node_html = $this->col('col-sm-12', $node_output_with_the_view_mode);
                $final_view_mode_output .= $this->fillRow(1, $node_html);
   ...
   */
  protected function fillRow($number_of_coloumns, $node_html): string {
   ...
   */
  protected function col($col_class, $node_output_with_a_view_mode): string {
  ...
  public function help($route_name, RouteMatchInterface $route_match) {
    switch ($route_name) {
      case 'help.page.varbase_styleguide':
        $readme = __DIR__ . '/../../README.md';
        $text = file_get_contents($readme);
        $output = '';

        // If the Markdown module is installed, use it to render the README.
        if ($text && $this->moduleHandler->moduleExists('markdown') === TRUE) {
        ...
        $output .= '<p>';
        $output .= $this->t('Visit the <a href=":project_link">Varbase Styleguide project page</a> on Drupal.org for more information.', [
          ':project_link' => 'https://www.drupal.org/project/varbase_styleguide',
        ]);
        $output .= '</p>';
