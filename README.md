[![pipeline status](https://git.drupalcode.org/project/varbase_styleguide/badges/9.2.x/pipeline.svg)](https://git.drupalcode.org/project/varbase_styleguide/-/pipelines)
[![Varbase Style Guide](https://img.shields.io/badge/Varbase%20Style%20Guide-9.2.0-0d6efc?labelColor=001d38&style=flat-square)](https://git.drupalcode.org/project/varbase_styleguide/-/pipelines?ref=9.2.0)
[![Automated Functional Testing](https://git.drupalcode.org/project/varbase_styleguide/badges/9.2.x/pipeline.svg)](https://git.drupalcode.org/project/varbase_styleguide/-/pipelines)
